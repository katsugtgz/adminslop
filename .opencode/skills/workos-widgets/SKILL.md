...
metadata:
  vendor: WorkOS
  scope: project
  source: workos skill v0.6.1
---

> **Project note.** In this repo WorkOS Widgets are an **enterprise/deferred**
> feature. Loading this skill does NOT imply approval to embed widgets. Surface
> that widgets are gated/paid and require owner sign-off before implementation
> (see `workos-authkit` skill directive #10).
